...
* TODO: C++ (use C++17) and Rust, finish individual plugin check and setup, remove unused plugins, keymapping, proper install Guide
...
| `<option>t` | Any | Opens terminal on next window |
