local configs = require("plugrc/lsp/config/configs")

local M = {
    util = require("plugrc/lsp/config/utils"),
}
...
function mt:__index(k)
  if configs[k] == nil then
    ...
    if success then
      ...
      vim.notify(
        string.format(
          "[lspconfig] Cannot access confiuration for %s. Ensure this server is listed in "
