-- TODO zsh tmux aliases
-- TODO symbols-outline doesnt work
-- TODO vim-ReplaceWithRegister you need to study it
-- TODO :104
...
return packer.startup(function(use)
    ...
    -- source code analysis and navigation
    use({
        "ray-x/navigator.lua",
        requires = {
