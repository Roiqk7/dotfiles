...
_G.packer_plugins = {
  ...
  nerdtree = {
    loaded = true,
    path = "/Users/roiqk/.local/share/nvim/site/pack/packer/start/nerdtree",
  ...
  ["vim-nerdtree-syntax-highlight"] = {
    loaded = true,
    path = "/Users/roiqk/.local/share/nvim/site/pack/packer/start/vim-nerdtree-syntax-highlight",
